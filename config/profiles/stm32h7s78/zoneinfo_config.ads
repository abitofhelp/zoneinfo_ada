pragma Ada_2022;
--  ==========================================================================
--  StarterLib_Config - STM32H7S78-DK Profile
--  ==========================================================================
...
--    - Can cache hundreds of parsed ZoneInfo files
--
--  Memory Strategy:
...
package ZoneInfo_Config is
   ...
   --  =======================================================================
   --  ZoneInfo Binary Parser Configuration (Generous)
   --  =======================================================================
   ...
   --  Maximum leap seconds in ZoneInfo file
   ...
   --  Can hold hundreds of parsed ZoneInfo files
