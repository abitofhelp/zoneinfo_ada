pragma Ada_2022;
--  ===========================================================================
--  Domain.Value_Object.Source_Info - Implementation
--  ===========================================================================
...
package body Domain.Value_Object.Source_Info is
   ...
   function Make_Version (Value : String) return Version_String is
   begin
   ...
   function Make_Path (Value : String) return Path_String is
   begin
   ...
   function Default_Source_Info return Source_Info is
     ((ULID       => Null_ULID,
   ...
   function Get_ULID (Source : Source_Info) return ULID_Type is
     (Source.ULID);

   function Get_Path (Source : Source_Info) return Path_String is
     (Source.Path);

   function Get_Version (Source : Source_Info) return Version_String is
     (Source.Version);

   function Get_Zone_Count (Source : Source_Info) return Natural is
     (Source.Zone_Count);
   ...
   overriding function "=" (Left, Right : Source_Info) return Boolean is
     (Left.ULID = Right.ULID);

   function "<" (Left, Right : Source_Info) return Boolean is
     (Left.ULID < Right.ULID);
