...
with ZoneInfo.Infrastructure.StarterLib_Parser;
with ZoneInfo.Domain.Service.Timezone_Lookup;
with ZoneInfo.Domain.StarterLib_Data;

package body ZoneInfo.Infrastructure.Query_Timezone_Info is

   use ZoneInfo.Infrastructure.StarterLib_Parser;
   use ZoneInfo.Domain.Service.Timezone_Lookup;
   ...
   begin
      ...
      if not Infrastructure.StarterLib_Parser.Parse_Result.Is_Ok (Parse_Result) then
         --  Return parsing error
         declare
            use ZoneInfo.Domain.Error;
            Parse_Error   : constant Error_Type :=
              Infrastructure.StarterLib_Parser.Parse_Result.Error_Info
                (Parse_Result);
      ...
      declare
         Data : constant StarterLib_Data_Type :=
           Infrastructure.StarterLib_Parser.Parse_Result.Value (Parse_Result);
