...
The zoneinfo library follows strict center-seeking dependency rules:
...
### 2. Stand-Alone Library with Library_Interface (Recommended - IMPLEMENTED in zoneinfo)
...
- ✅ **IMPLEMENTED in zoneinfo library** - Application layer already configured
...
### Library Projects (like zoneinfo)
...
| Strategy | Compile-Time | Transitive Prevention | Effort | Strictness | Status in zoneinfo |
|----------|-------------|---------------------|--------|------------|----------------|
