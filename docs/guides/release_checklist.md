...
- Version package updated (shared/src/zoneinfo-version.ads)
...
```bash
# Ensure that you have updated the content of changelog.md 
# from git history.  The content is NOT automatically generated.
...
- [ ] **Update README.md**
  - Add section about execution modes:
    - Synchronous mode (zoneinfo-bootstrap-main.adb)
    - Asynchronous/Tasking mode (zoneinfo-bootstrap-main_concurrent.adb - post-1.0)
...
- [ ] **Refactor concurrent version for Option B**
  - Update zoneinfo-bootstrap-main_concurrent.adb
...
- GitHub Issues: https://github.com/abitofhelp/zoneinfo/issues
