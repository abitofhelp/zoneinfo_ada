#!/usr/bin/env bash
# ===========================================================================
# run_gnatcov.sh - GNATcoverage workflow for starterlib project
# ===========================================================================
...
# Requirements:
#   - gnatcov in PATH
#   - gnatcov_rts runtime built and installed (done in tools/)
#
# Usage:
...
RUNTIME="$ROOT/tools/gnatcov_rts_install/share/gpr"
...
echo -e "${BLUE}========================================${NC}"
echo -e "${BLUE}  GNATcoverage for starterlib${NC}"
echo -e "${BLUE}========================================${NC}"
